...
case $1 in
"run")
  $(echo "exec ros2 run velodyne_driver velodyne_driver_node --ros-args -p device_ip:='192.168.1.22' -p model:='VLP16' -p rpm:=1200.0;exec ros2 launch velodyne_pointcloud velodyne_transform_node-VLP16-launch.py")
  ;;
